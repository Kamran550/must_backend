...
class AcceptanceLetterMail extends Mailable
{
    ...
    public function attachments(): array
    {
        try {
            ...
            $fileName = 'Conditional_Acceptence_Letter_' . $this->student->first_name . '_' . $this->student->last_name . '_'
                . ($verificationCode ?? 'student-' . $this->student->id) . '_' . now()->format('Y-m-d') . '.pdf';
